...
def main() -> int:
    ...
    parser.add_argument("--crd-dir", type=Path, default=Path(__file__).resolve().parents[1] / "charts/polyad/crds")
    ...
    if changed:
        ...
        if args.check:
            print("Run: bash scripts/project-python.sh scripts/generate-status-schemas.py")
