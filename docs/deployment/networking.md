...
[temporary connections API](../apis/temporary-connections.md). It uses projected service-account
...
[workload topology events](../workloads/workload-events.md) for the payload, client example,
