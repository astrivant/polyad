...
Current [Secret reloads](authentication.md#restart-consumers-after-rotation) act
...
That bootstrap is outside the [operator's own Graph](components.md), so it needs
...
The existing [mutation planner](mutations.md) supplies effect declarations,
