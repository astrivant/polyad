...
independent clusters. See [replication](replication.md) and
[GraphRule scope](graph-rules.md#scope).
...
configuration, combine the [PolyGraph replica example](replication.md#example-polygraph-replicas)
and [KEDA target](replication.md#connect-keda) with
...
Enable [ESO restart annotations](authentication.md#restart-consumers-after-rotation)
