...
See [workload API access](../deployment/networking.md#workload-access-to-operator-apis) and
...
The [connections endpoint](../apis/temporary-connections.md) requires a projected service-account token.
