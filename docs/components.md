...
[ReplicaGroup connectivity configurations](replication.md#connections-between-copies)
...
[KEDA policies](replication.md#connect-keda). More telemetry copies add serving
