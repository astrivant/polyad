...
see [network enforcement and lifecycle](networking.md#enforcement-and-lifecycle).
...
[enforcement lifecycle](networking.md#enforcement-and-lifecycle). Kubernetes reads
