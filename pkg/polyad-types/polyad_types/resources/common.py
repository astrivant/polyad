...
class ResourceType:
    ...
    Attributes:
        ...
        auxiliary (Literal['network', 'capacity', 'activation', 'connection'] | None): Supporting role, excluded from graph vertices.
    ...
    auxiliary: Literal["network", "capacity", "activation", "connection"] | None = None
