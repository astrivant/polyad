...
- `polyad-benchmarks-refresh --ci-phase prepare|study|finish --root DIRECTORY`:
  ...
  and process-rerouting studies without a cluster. Install
  ...
  With the operator package available, `--suite cheeger` runs the
  [production strategy study](../../studies/cheeger-strategies/README.md),
  including churn, policy thresholds, cache pressure and resource budgets.
  The [deprecated PCA reduction study](../../studies/cheeger-reduction-deprecated/README.md)
  remains archived and is excluded from refreshes.
