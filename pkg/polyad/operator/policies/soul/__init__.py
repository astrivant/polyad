"""
Coordinate application-driven graph adaptation through one bounded decision pipeline.

Start with controller.search_soul: observe live capacity, propose an
