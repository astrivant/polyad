...
def openapi_document(title: str, version: str) -> dict[str, Any]:
    ...
    spec.path(
        ...
        operations={
            "post": {
                "operationId": "reportAdaptation",
                "summary": "Report an SDK strategy invocation lifecycle transition",
                "requestBody": {"required": True, "content": {"application/json": {"schema": reference("AdaptationReport")}}},
                "responses": {
                    **errors,
