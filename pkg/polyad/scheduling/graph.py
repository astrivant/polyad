...
from polyad.scheduling.scheduler import Scheduler, State
...
class Graph(Workload):
    """
    Reserve a parent allocation around an independently scheduled dynamic child graph.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            policy (SchedulingPolicy | None): Independent scheduling policy inside this graph.
