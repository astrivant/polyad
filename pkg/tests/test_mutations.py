...
def planner_capacity(monkeypatch):
    """
    Enable two callbacks so these tests exercise the planner's independence checks.
    """
    monkeypatch.setenv("POLYAD_MUTATION_PLANNER_PARALLELISM", "2")
