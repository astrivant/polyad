...
| [`values-cheeger.reference.yaml`](references/values-cheeger.reference.yaml) | Opt-in Cheeger reduction with adaptive PID scheduling and a separate soft computation-time target | [Cheeger tuning](../../docs/graphs/cheeger-tuning.md) |
